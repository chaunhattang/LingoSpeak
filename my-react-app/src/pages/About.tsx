      ...
      <main className="max-w-[900px] mx-auto px-4 md:px-10 py-16 mt-16 md:mt-24 space-y-16">
        ...
        <section className="flex flex-col items-center text-center gap-6">
          <p className="text-xl text-slate-500 max-w-lg leading-relaxed">
            Nền tảng học tiếng Anh thông minh — giúp bạn luyện nói, tích lũy từ
            vựng và tự tin giao tiếp mỗi ngày.
          </p>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-500 to-cyan-500 rounded-3xl p-8 text-white text-center shadow-lg">
          ...
          <p className="text-blue-50 leading-relaxed max-w-xl mx-auto">
            LingoSpeak được xây dựng với mục tiêu giúp người học tiếng Anh tại
            Việt Nam tiếp cận ngôn ngữ một cách tự nhiên và hiệu quả — không áp
            lực, không nhàm chán, chỉ cần 15–20 phút mỗi ngày.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {stack.map((s) => (
              ...
              >
                <span
                  className={`material-symbols-outlined text-[22px] ${s.color}`}
                >
                  {s.icon}
                </span>
