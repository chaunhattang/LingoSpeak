...
const LessonSpeakingPractice = () => {
            ...
            <div className="flex items-center gap-2 mt-1">
              <div className="w-32 h-2 bg-gray-100 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${((currentIndex + 1) / conversation.length) * 100}%`,
                  }}
                />
              </div>
  ...
  "
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                <button className="w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center rounded-full bg-blue-100 hover:opacity-90 transition">
                ...
                {/* Mic - lớn hơn */}
                <button className="w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center rounded-full bg-blue-600 text-white hover:bg-blue-700 transition shadow-xl">
